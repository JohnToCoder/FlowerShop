...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Calendar ID="Calendar1" runat="server" BackColor="#FFFFCC" BorderColor="#FFCC66"
        ...
        ForeColor="#663399" Height="274px" ShowGridLines="True" Width="242px">
    ...
    &nbsp;&nbsp;
    <div style="z-index: 101; left: 244px; width: 316px; position: absolute; top: 37px;
        height: 275px">
        <asp:Login ID="Login1" runat="server" BackColor="#FFFBD6" BorderColor="#FFDFAD" BorderPadding="4"
            BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em"
            ForeColor="#333333" Height="229px" Width="281px" TextLayout="TextOnTop">
            ...
            <LayoutTemplate>
                <table border="0" cellpadding="4" cellspacing="0" style="border-collapse: collapse">
                    <tr>
                        <td>
                            <table border="0" cellpadding="0" style="width: 281px; height: 229px">
                                <tr>
